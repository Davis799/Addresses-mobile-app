...
import { StyleSheet, Button, TextInput, View, Text, Keyboard, TouchableWithoutFeedback, ScrollView, ImageBackground} from 'react-native'; 
         ...
         >
             {(props) => (
                ...
                <View style={styles.center}>  
                    <Text style={globalStyles.title}>ADD USER</Text>
